...
> Sem o `.gitattributes` versionado, colaboradores não sabem que aqueles arquivos são LFS. Por isso a janela **stagea o `.gitattributes` automaticamente** após track/untrack — ver [[../Fluxos/2 - Track Commit Push]].
...
Cada método do [[../Arquivos-Chave/LfsService]] mapeia diretamente para um destes comandos; as três abas da [[../Arquivos-Chave/LfsForm]] agrupam-nos por etapa. Ver [[../Decisoes/Fluxo em 3 etapas (abas)]].

## 🔗 Relacionado
- [[GitExtensions.ZimerfeldLFS]]
- [[../Arquivos-Chave/LfsService]]
- [[../Fluxos/2 - Track Commit Push]]
