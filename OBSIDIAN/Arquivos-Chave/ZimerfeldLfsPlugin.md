...
O atributo `[Export]` é o ponto de descoberta pelo MEF do host. Ver [[../02 - Conhecimento/Plugin MEF para GitExtensions]].

---

## Construtor — `: base(false)`
...
- **Não assina nenhum evento do host.** O comentário no código é explícito: o repositório da janela vem **exclusivamente** do `cboRepo`; o working dir do host é usado só como valor pré-selecionado ao abrir. Ver [[../Decisoes/Diretório de trabalho independente]].
