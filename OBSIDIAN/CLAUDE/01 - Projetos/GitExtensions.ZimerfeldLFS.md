...
- **Fluxo guiado em três etapas (abas):** ver [[Fluxos/1 - Instalação]], [[Fluxos/2 - Track Commit Push]], [[Fluxos/3 - Clone e Pull]].
...
Três classes, cada uma com uma responsabilidade única (ver [[Arquitetura]]):
```
GitExtensions (host)
    │ MEF
    ▼
...
- [[Git LFS - Conceitos]]
- [[Arquitetura]] · [[Visão Geral]] · [[Versionamento]] · [[Dependências]]
