...
O ícone comunica de relance "**arquivos grandes de mídia**" (jogos/áudio/vídeo/dados) e "**explode/pesa**" (a bomba) — os candidatos naturais ao Git LFS. Ver [[../Decisoes/Ícone 4 quadrantes + bomba]].

---

## Relacionado

- [[../Decisoes/Ícone 4 quadrantes + bomba]]
- [[build.ps1]]
