...
- **Diálogos nativos:** Commit e Push usam os diálogos do próprio GitExtensions (via delegates `openCommit`/`openPush` que resolvem `WithWorkingDirectory(dir)`), então todos os plugins de commit carregam normalmente. Ver [[🔌 ZimerfeldLfsPlugin]].
