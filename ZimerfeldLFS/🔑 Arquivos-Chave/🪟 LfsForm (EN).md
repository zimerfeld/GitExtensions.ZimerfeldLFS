...
- **Language:** Automatic/Portuguese/English/Spanish dropdown → `I18n.SetLanguage` → `ApplyLanguage()` reloads the `Translator` and rewrites all texts. `_suppressLangEvent` avoids re-entrancy when repopulating the combo.
