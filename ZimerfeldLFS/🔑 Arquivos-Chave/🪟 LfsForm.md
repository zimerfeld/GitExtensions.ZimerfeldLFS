...
- **Idioma:** dropdown Automático/Português/Inglês/Espanhol → `I18n.SetLanguage` → `ApplyLanguage()` recarrega o `Translator` e reescreve todos os textos. `_suppressLangEvent` evita reentrância ao repopular o combo.
