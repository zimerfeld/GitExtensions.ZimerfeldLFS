...
## 📐 Convenções
- Datas: `AAAA-MM-DD`
- **Este projeto** é um **plugin MEF de GitExtensions** que gerencia **Git LFS** numa janela dedicada em 3 etapas (Instalação / Fluxo básico / Clone & Pull), com **diretório de trabalho independente** do host. Ver [[📦 GitExtensions.ZimerfeldLFS]] e [[🗃️ Git LFS - Conceitos]]
