// SponsorBanner.cs — top-of-window GitHub Sponsors badge shared by all ZimerfeldLFS windows
...
internal static class SponsorBanner
{
    ...
    private const string BadgeResource = "GitExtensions.ZimerfeldLFS.Resources.sponsor-badge.png";

    private const string KofiUrl       = "https://ko-fi.com/C0D621FCGD";
    private const string KofiResource  = "GitExtensions.ZimerfeldLFS.Resources.kofi-badge.png";
    ...
    /// vertically aligned with the sponsor badge. The caller keeps the reference (e.g. for live
    /// re-localization) and wires its click handler before passing it in.
    /// </summary>
